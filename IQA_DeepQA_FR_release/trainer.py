...
class Trainer(object):
    """
    # Trainer classs managing training and testing routines.
    Trains & tests models over epochs, shows monitoring variables,
    save model snapshots, store data and images.
    ...
    def training_routine(self, model, get_train_outputs, rec_train,
        ...
        # if check_mos_corr is True -> best_score_set = (SRCC, PLCC)
        # else -> best_score_set = (losses[0], losses[1])
            ...
            if test_model or save_data:
                ...
                for test_bat_idx in range(0, n_test_batches):
                    ...
                    if (save_data and rec_test.num_imgs > 0 and
                            test_bat_idx < n_valid_rec_batches):
                        if test_data.imagewise:
                            # if imagewise is True, reconstructs a complete
                            # image using the patches in the minibatch
